...
def test_timeout_with_solve_binary():
    old_timeout = qcware.config.max_client_timeout()
    qcware.config.set_max_client_timeout(0)
    old_server_timeout = qcware.config.max_server_timeout()
    qcware.config.set_max_server_timeout(0)
    ...
    qcware.config.set_max_client_timeout(old_timeout)
    qcware.config.set_max_server_timeout(old_server_timeout)
