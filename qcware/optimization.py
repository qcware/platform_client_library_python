...
def solve_binary(key,
                 ...
                 higher_order=None,
                 solver=None,
                 constraints_linear_A=None,
                 constraints_linear_b=None,
                 constraints_sat_max_runs=None,
                 constraints_hard=None,
                 constraints_penalty_scaling_factor=None,
                 constraints_equality_R=None,
                 constraints_equality_c=None,
                 constraints_inequality_S=None,
                 constraints_inequality_d=None,
                 return_all_solutions=None,
                 num_runs=None,
                 ...
                 sample_persistence_persistence_threshold=None,
                 sample_persistence_persistence_iterations=None,
                 google_num_steps=None,
                 google_n_samples=None,
                 google_arguments_optimizer=None,
                 google_step_sampling=None,
                 google_n_samples_step_sampling=None,
    ...
    if higher_order is not None:
        params["higher_order"] = higher_order
    if solver is not None:
        params["solver"] = solver
    if constraints_linear_A is not None:
        params["constraints_linear_A"] = constraints_linear_A
    if constraints_linear_b is not None:
        params["constraints_linear_b"] = constraints_linear_b
    if constraints_sat_max_runs is not None:
        params["constraints_sat_max_runs"] = constraints_sat_max_runs
    if constraints_hard is not None:
        params["constraints_hard"] = constraints_hard
    if constraints_penalty_scaling_factor is not None:
        params["constraints_penalty_scaling_factor"] = constraints_penalty_scaling_factor
    if constraints_equality_R is not None:
        params["constraints_equality_R"] = constraints_equality_R
    if constraints_equality_c is not None:
        params["constraints_equality_c"] = constraints_equality_c
    if constraints_inequality_S is not None:
        params["constraints_inequality_S"] = constraints_inequality_S
    if constraints_inequality_d is not None:
        params["constraints_inequality_d"] = constraints_inequality_d
    if return_all_solutions is not None:
        params["return_all_solutions"] = return_all_solutions
    ...
    if use_sample_persistence is not None:
        params["use_sample_persistence"] = use_sample_persistence
    if sample_persistence_solution_threshold is not None:
        params["sample_persistence_solution_threshold"] = sample_persistence_solution_threshold
    if sample_persistence_persistence_threshold is not None:
        params["sample_persistence_persistence_threshold"] = sample_persistence_persistence_threshold
    if sample_persistence_persistence_iterations is not None:
        params["sample_persistence_persistence_iterations"] = sample_persistence_persistence_iterations
    if google_num_steps is not None:
        params["google_num_steps"] = google_num_steps
    if google_n_samples is not None:
        params["google_n_samples"] = google_n_samples
    if google_arguments_optimizer is not None:
        params["google_arguments_optimizer"] = google_arguments_optimizer
    if google_step_sampling is not None:
