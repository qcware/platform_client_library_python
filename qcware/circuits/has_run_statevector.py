...
async def async_has_run_statevector(backend:str, backend_args:object={}, api_key:str=None, host:str=None):
    r"""Async version of has_run_statevector
Whether or not this backend supports the run_statevector method.  This can be called more elegantly by the use of the QuasarBackend class.
