...
async def async_has_statevector_input(backend:str, backend_args:object={}, api_key:str=None, host:str=None):
    r"""Async version of has_statevector_input
Whether or not this backend supports statevector input for various run methods. This can be called more elegantly by the use of the QuasarBackend class.
