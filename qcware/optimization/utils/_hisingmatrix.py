...
class HIsingMatrix(PUBOMatrix):
    ...
    ``help(qcware.optimization.utils.PUBOMatrix)``.
    ...
    can in general be arbitrarily long! See ``qcware.optimization.utils.IsingMatrix``
    ...
    def solve_bruteforce(self, all_solutions=False):
        ...
        ``qcware.optimization.utils.solve_hising_bruteforce(self, all_solutions)[1]``.

        Parameters
        ----------
        all_solutions : bool.
            See the description of the ``all_solutions`` parameter in
            ``qcware.optimization.utils.solve_hising_bruteforce``.
    ...
    def value(self, x):
        ...
        Find the value of
            ...
            ``qcware.optimization.utils.hising_value(z, self)``.
        ...
        Example
        -------
        >>> from qcware.optimization.utils import IsingMatrix, HIsingMatrix
        >>> from qcware.optimization import Ising, HIsing
