...
class PUBOMatrix(DictArithmetic):
    ...
    ``help(qcware.optimization.utils.DictArithmetic)``.
    ...
    can in general be arbitrarily long! See ``qcware.optimization.utils.QUBOMatrix``
    ...
    def __init__(self, *args, **kwargs):
        ...
        or ``qcware.optimization.utils.DictArithmetic`` for details on the inputs.

        Parameters
        ----------
        arguments : parameters.
            Defined in child classes or in ``qcware.optimization.utils.DictArithmetic``.
    ...
    def refresh(self):
        ...
        is being built (and in subclasses such as ``qcware.optimization.PUBO``, properties
        ...
        Examples
        --------
        >>> from qcware.optimization.utils import PUBOMatrix
        >>> P = PUBOMatrix()
        >>> P[(0,)] += 1
    ...
    def solve_bruteforce(self, all_solutions=False):
        ...
        ``qcware.optimization.utils.solve_pubo_bruteforce(self, all_solutions)[1]``.

        Parameters
        ----------
        all_solutions : bool.
            See the description of the ``all_solutions`` parameter in
            ``qcware.optimization.utils.solve_pubo_bruteforce``.
    ...
    def value(self, x):
        ...
        ``qcware.optimization.utils.pubo_value(x, self)``.
        ...
        Example
        -------
        >>> from qcware.optimization.utils import QUBOMatrix, PUBOMatrix
        >>> from qcware.optimization import QUBO, PUBO
