...
Contains the QUBO class. See ``help(qcware.optimization.QUBO)``.
...
class QUBO(BO, QUBOMatrix):
    ...
    ``qcware.optimization.utils.QUBOMatrix``. Note that it is generally
    ...
    ``help(qcware.optimization.utils.QUBOMatrix)``.
    ...
    def __init__(self, *args, **kwargs):
        ...
        ``qcware.optimization.utils.QUBOMatrix``. Note that it is generally more efficient
