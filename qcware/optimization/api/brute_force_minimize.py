...
:param objective: The integer-coefficient polynomial to be evaluated should be specified by an ObjectiveFunction. See documentation for ObjectiveFunction for more information. Note that variables are boolean in the sense that their values are 0 and 1.
