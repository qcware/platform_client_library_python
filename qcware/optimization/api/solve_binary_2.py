...
from qcware.types.optimization.qcware_binary_results import BinaryProblem

def submit_solve_binary_2(Q: BinaryProblem,
                        backend: str,
...
:rtype: str
    """
    data = client_args_to_wire('optimization.solve_binary_2', **locals())
    api_call = post_call('optimization/solve_binary_2', data)
    return api_call['uid']


def solve_binary_2(Q: BinaryProblem,
                 backend: str,
                 constraints_linear_A: list = [],
                 constraints_linear_b: list = [],
                 constraints_sat_max_runs: int = 3100,
...
:rtype: dict
    ...
    logger.info(
        f'API call to optimization.solve_binary successful. Your API token is {api_call_id}'
    )
    if client_timeout() == 0:
...
async def async_solve_binary_2(
        Q: BinaryProblem,
        backend: str,
        constraints_linear_A: list = [],
        constraints_linear_b: list = [],
